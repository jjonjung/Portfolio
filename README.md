...
<table>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p><strong>Key Achievement</strong>: AI Agent 연동을 통한 지능형 공연 연출 플랫폼 구현</p>
      <p><strong>Technical Focus</strong>: AI 에이전트 인터페이스, 모션 캡처 데이터 연동</p>
      <p><strong>Keywords</strong>: <code>AI Integration</code> <code>Virtual Human</code> <code>Motion Capture</code></p>
      <p>Git: <a href="https://github.com/jjonjung/AiNextIdol">https://github.com/jjonjung/AiNextIdol</a></p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      ...
      <p><strong>Key Achievement</strong>: 수학적 확률을 적용한 <strong>적 AI 움직임 및 물리 기반 낙하지점 예측</strong> 구현</p>
      <p><strong>Technical Focus</strong>: 공격/수비 역할 동적 전환 시스템, 물리 기반 스킬</p>
      <p><strong>Keywords</strong>: <code>AI</code> <code>Physics</code> <code>Vector Math</code> <code>Predictive Logic</code></p>
      <p>Git: <a href="https://github.com/jjonjung/LucioBall">https://github.com/jjonjung/LucioBall</a></p>
    </td>
    <td width="50%" valign="top">
      ...
      <p><strong>Key Achievement</strong>: 캐릭터 액션 시스템, 카메라 시퀀스 구현</p>
      <p><strong>Technical Focus</strong>: 상태 머신(FSM) 기반 행동 트리, 정교한 입력 처리</p>
      <p><strong>Keywords</strong>: <code>Blueprint</code> <code>Action RPG</code> <code>FSM</code> <code>Combat System</code></p>
      <p>Git: <a href="https://github.com/jjonjung/BlackWukong">https://github.com/jjonjung/BlackWukong</a></p>
    </td>
  </tr>
</table>
